...
I characterize the identified set for the treatment effect of the treated unit, which admits a linear programming representation with estimated coefficients and potentially many nuisance parameters. I provide a valid confidence set for this identified set that profiles out nuisance parameters and illustrate its finite-sample performance in a simulation study.
</div>
